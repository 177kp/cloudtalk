...
public class Message implements java.io.Serializable {
    ...
    public Message(Long id, int msgId, int fromId, int toId, String sessionKey, String content, int msgType, int sessionType, int displayType, int status, int created, int updated) {
        this.id = id;
        this.msgId = msgId;
        this.fromId = fromId;
        this.toId = toId;
    ...
    public boolean equals(Object o) {
        ...
        if (sessionType != that.sessionType) return false;

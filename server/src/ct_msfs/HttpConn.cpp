                                        ...
                                        if (NULL != pPos)
                                        {
                                            ...
                                            if (NULL != pPos2)
                                            {
                                                ...
                                                if (nFileSize <= HTTP_UPLOAD_MAX)
                                                {
                                                    ...
                                                    char url[1024];
                                                    snprintf(url, sizeof(url),"{\"error_code\":0,\"code\":0,\"error_msg\":\"成功\",\"msg\": \"成功\",\"path\":\"%s\",\"url\":\"http://%s/%s\",\"data\":{\"src\":\"http://im.b56.cn:9701/%s\"}}",
                                                                 filePath, m_strAccessHost.c_str(), filePath,filePath);

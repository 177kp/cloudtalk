...
public interface DBConstant {
    ...
    /**msgType*/
    public final int  MSG_TYPE_TEXT = 0x01;
    public final int  MSG_TYPE_AUDIO = 0x02;
    public final int  MSG_TYPE_SYSTEM = 136;
    public final int  MSG_TYPE_NOTICE_FRIEND = 137;
    public final int  MSG_TYPE_NOTICE_SYSTEM = 144;
    ...
    public final int SESSION_TYPE_PUBLICACCUNT=6;

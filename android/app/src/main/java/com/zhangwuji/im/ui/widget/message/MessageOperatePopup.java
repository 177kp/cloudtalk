...
public class MessageOperatePopup implements View.OnClickListener, View.OnTouchListener {
    ...
    private TextView copyBtn, resendBtn, speakerBtn,withdrawBtn;
    private boolean bcopyShow, bresendShow, bspeakerShow,withdrawShow;
    ...
    private MessageOperatePopup(Context ctx, View parent) {
        ...
        withdrawBtn = (TextView) view.findViewById(R.id.withdraw_btn);
        withdrawBtn.setOnClickListener(this);
        withdrawBtn.setOnTouchListener(this);
        withdrawBtn.setPadding(0, 13, 0, 8);
    ...
    public void show(View item, int type, boolean bResend, boolean bSelf) {
        ...
        if(withdrawShow)
        {
            ...
            Drawable bgRight = resource
                    .getDrawable(R.drawable.tt_bg_popup_normal);
            withdrawBtn.setBackgroundDrawable(bgRight);
            withdrawBtn.setPadding(0, 13, 0, 8);
        }
    ...
    public void onClick(View v) {
        ...
        if(R.id.withdraw_btn==id)
        {
            dismiss();
            if (mListener != null) {
                mListener.onWithdrawClick();
            }
        }
        else if (R.id.copy_btn == id) {
            dismiss();
            if (mListener != null) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            if(R.id.withdraw_btn==v.getId())
            {
                Drawable drawable = null;
                drawable = resource
                        .getDrawable(R.drawable.tt_bg_popup_normal);
                if (drawable != null) {
                    withdrawBtn.setBackgroundDrawable(drawable);
                    withdrawBtn.setPadding(0, 13, 0, 8);
                }
            }
            else if (R.id.copy_btn == v.getId()) {
                Drawable drawable = null;
                if (bcopyShow && bresendShow) {
                    drawable = resource
                            .getDrawable(R.drawable.tt_bg_popup_left_nomal);
            ...
            if(R.id.withdraw_btn==v.getId())
            {
                ...
                if (drawableCopy != null) {
                    withdrawBtn.setBackgroundDrawable(drawableCopy);
                    withdrawBtn.setPadding(0, 13, 0, 8);
                }

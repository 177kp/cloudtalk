...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    public static class Properties {
        ...
        public final static Property DisplayType = new Property(8, int.class, "displayType", false, "DISPLAY_TYPE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Message\" (" + //
                ...
                "\"DISPLAY_TYPE\" INTEGER NOT NULL ," + // 8: displayType
    ...
    protected final void bindValues(DatabaseStatement stmt, Message entity) {
        ...
        stmt.bindLong(9, entity.getDisplayType());
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.getInt(offset + 8), // displayType
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setDisplayType(cursor.getInt(offset + 8));

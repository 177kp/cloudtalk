...
public class AudioRenderView extends  BaseMsgRenderView {
     ...
     */
    @Override
    public void render(IMessageData iMessageData, final Message messageEntity, final User userEntity, final Context ctx) {
        super.render(iMessageData,messageEntity, userEntity,ctx);
